...
p.innerHTML = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. ${totalUnfunded} game${totalUnfunded === 1 ? '' : 's'} currently remain${totalUnfunded === 1 ? 's' : ''} unfunded. We need your help to fund these amazing games!`;
...
secondGameContainer.append(secondPledgeGameElement);